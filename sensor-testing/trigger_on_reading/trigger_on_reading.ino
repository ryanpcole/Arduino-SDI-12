 ...
 * @date August 
 *
 * @brief Check all Addresses for Active Sensors and Log Data
 *
...
// TODO Write function to create buffer for stored temperature and turbidity values


// TODO Write function to trigger pulling another Digital pin on the arduino hi or low based on last red value
// Don't forget to return it to low after triggering. Will there be a response from the ISCO?
